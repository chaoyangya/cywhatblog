...
!function (e, t) {
    ...
    return function (e) {
        ...
        t.DEFAULT_EMOJI_CDN = "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/", t.DB_NAME = "Comment", t.DEFAULT_CONFIG = {
            ...
            enableQQ: !1,
            requiredFields: []
        }, t.DEFAULT_META = ["nick", "mail", "link"], t.VERSION = "1.4.6"
    }, function (e, t, n) {
        "use strict";
        t.__esModule = !0;
        ...
        var x = n(2).FilterCSS, k = n(2).getDefaultWhiteList, _ = n(4), A = new x, S = /</g, O = />/g, $ = /"/g,
            ...
            C = /e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi, M = /u\s*r\s*l\s*\(.*/gi, z = /<!--[\s\S]*?-->/g;
...
*/
        ...
        o.prototype.init = function (e) {
            ...
            var t = this;
            return e && (e = w.default.extend(h.DEFAULT_CONFIG, e), t.i18n = (0, d.default)(e.lang || w.default.lang, e.langMode), t.config = e, e.emojiMaps && (f.default.maps = e.emojiMaps, f.default.cdn = e.emojiCDN), t._init()), t
            ...
            try {
                ...
                j.params = "?d=" + (u.indexOf(n) > -1 ? n : "mp") + "&v=" + h.VERSION + d, j.hide = "hide" === n, j.cdn = /^https?\:\/\//.test(o) ? o : j.cdn, e.config.pageSize = isNaN(l) ? 10 : l < 1 ? 10 : l, c && (w.default.sdkLoader("//api.ip.sb/jsonip?callback=getIP", "getIP"), window.getIP = function (e) {
                    $.ip = e.ip
                });
                var p = e.config.el || null, f = (0, w.default)(p);
                if (p = p instanceof HTMLElement ? p : f[f.length - 1] || null) {
                    e.$el = (0, w.default)(p), e.$el.addClass("v").attr("data-class", "v"), j.hide && e.$el.addClass("hide-avatar"), e.config.meta = (e.config.guest_info || e.config.meta || h.DEFAULT_META).filter(function (e) {
                    ...
                    var y = e.$el.find(".vload-bottom"), b = e.$el.find(".vload-top");
                    e.$loading = {
                        show: function (t) {
                            return t && b.show() || y.show(), e.$nodata.hide(), e
                        }, hide: function () {
                            return b.hide(), y.hide(), 0 === e.$el.find(".vcard").length && e.$nodata.show(), e
                        }
                    }
                }
                (0, A.default)(e.config, function (t) {
                    var n = (0, w.default)(".valine-comment-count"), r = 0;
                    !function t(n) {
                        var o = n[r++];
                        if (o) {
                            var i = (0, w.default)(o).attr("data-xid");
                    ...
                    }(n), i && P.add(AV.Object.extend("Counter"), e.config.path), e.bind()
                })
            } catch (t) {
        ...
        o.prototype.Q = function (e) {
            ...
            var n = this;
            if (n.$el && n.$loading.hide().$nodata.hide() && n.$el.find(".vwrap").hide(), "[object Error]" === {}.toString.call(e)) {
            ...
            e.$emoji = {
                ...
                show: function () {
                    return E ? (e.$emoji.hide(), o.addClass("actived"), n.html(E).show(), I()) : e.$preview.hide(), e.$preview
                }, hide: function () {
                    return o.removeClass("actived"), n.hide().html(""), e.$preview
                }
            };
            var d = function (e) {
                E = (0, k.default)(f.default.parse(e.val() || "")), o.hasClass("actived") > -1 && E != n.html() && n.html(E), (0, c.default)(e[0]), I()
            };
            ...
            for (var m in v) v.hasOwnProperty(m) && function () {
                ...
                h[t] = n, n.on("input change blur propertychange", function (r) {
                    e.config.enableQQ && "blur" === r.type && "nick" === t && !isNaN(n.val()) && (0, O.default)(n.val(), function (e) {
                        var t = e.name || n.val();
            ...
            var S = function (t, n, r) {
                ...
                var l = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : "http://" + t.get("link") : "",
                    ...
                    u = j.hide ? "" : e.config.enableQQ && t.get("QQAvatar") ? '<img class="vimg" src="' + t.get("QQAvatar") + '" referrerPolicy="no-referrer"/>' : '<img class="vimg" src="' + (j.cdn + (0, s.default)(t.get("mail")) + j.params) + '">',
            ...
            var M = e.$el.find(".vsubmit"), z = function (t) {
                if (e.config.requiredFields.indexOf("nick") > -1 && $.nick.length < 3) return h.nick[0].focus(), void e.$el.find(".status-bar").text("" + e.i18n.t("nickFail")).empty(3e3);
                if (e.config.requiredFields.indexOf("mail") > -1 && !/[\w-\.]+@([\w-]+\.)+[a-z]{2,3}/.test($.mail)) return h.mail[0].focus(), void e.$el.find(".status-bar").text("" + e.i18n.t("mailFail")).empty(3e3);
